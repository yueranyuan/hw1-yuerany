...
public class BaseAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("base.BaseAnnotation");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "base.BaseAnnotation");
  ...
  public float getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "base.BaseAnnotation");
